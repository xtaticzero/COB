 ...
 * @author Daniel
 */
public class ConsultarMontoIcepMapper implements RowMapper<Resolucion> {

    private Logger log = Logger.getLogger(ConsultarMontoIcepMapper.class);
    ...
    public Resolucion mapRow(ResultSet rs, int i) throws SQLException {
        ...
        resolucion.setClaveICEP(rs.getLong("CLAVEICEP"));
            ...
            log.debug("no se pudo obtener claveicep");
            log.error(ex);
        }
