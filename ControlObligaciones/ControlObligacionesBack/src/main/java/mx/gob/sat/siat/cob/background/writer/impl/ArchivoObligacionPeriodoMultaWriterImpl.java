 ...
 * @author Juan
 */
@Service("archivoObligacionPeriodoMultaWriter")
@Scope("step")
public class ArchivoObligacionPeriodoMultaWriterImpl extends FlatFileItemWriter
        implements ArchivoObligacionPeriodoWriter {

    public ArchivoObligacionPeriodoMultaWriterImpl() {
