...
import mx.gob.sat.siat.cob.background.reader.ReqsAnterioresSlaveItemReader;
 ...
 * @author Juan
 */
@Service("reqsAnterioresSlaveItemReader")
@Scope("step")
public class ReqsAnterioresSlaveItemReaderImpl implements ReqsAnterioresSlaveItemReader {
    ...
    @Override
    public RequerimientosAnteriores read() {
