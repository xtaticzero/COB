...
import mx.gob.sat.siat.cob.background.partitioner.CargaMultaArchivoPartitioner;
 ...
 * @author Juan
 */
@Service("cargaMultaArchivoPartitioner")
@Scope("step")
public class CargaMultaArchivoPartitionerImpl implements CargaMultaArchivoPartitioner {
