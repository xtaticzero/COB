...
import mx.gob.sat.siat.cob.background.reader.ArchivoObligacionPeriodoMultaReader;
 ...
 * @author Juan
 */
@Service("archivoObligacionPeriodoMultaReader")
@Scope("step")
public class ArchivoObligacionPeriodoMultaReaderImpl extends FlatFileItemReader
        implements ArchivoObligacionPeriodoMultaReader {

    public ArchivoObligacionPeriodoMultaReaderImpl() {
    ...
    @Value(ConstantsCatalogos.RUTA_ARCHIVO_OBLIGACION_PERIODO_MULTA)
    @Override
